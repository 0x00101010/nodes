...
BEACON_NODE_EL_LOCAL_DNS="${BEACON_NODE_EL_LOCAL_DNS:-http://geth}"
BEACON_NODE_EL_AUTH_RPC_PORT="${BEACON_NODE_EL_AUTH_RPC_PORT:-8551}"
BEACON_NODE_EL_ENDPOINT="$BEACON_NODE_EL_LOCAL_DNS:$BEACON_NODE_EL_AUTH_RPC_PORT"
