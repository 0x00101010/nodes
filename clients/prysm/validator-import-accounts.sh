...
VALIDATOR_KEYSTORE_PASSWORD_FILE="${VALIDATOR_KEYSTORE_PASSWORD_FILE:-/config/keystore-passwd}"
VALIDATOR_WALLET_DIR="${VALIDATOR_WALLET_DIR:-/data/wallet}"
VALIDATOR_WALLET_PASSWORD_FILE="${VALIDATOR_WALLET_PASSWORD_FILE:-/config/wallet-passwd}"
